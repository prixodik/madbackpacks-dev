<template>
	<div class="video-block">
		<img class="video-block__bg-pink" src="/madbackpacks-dev/images/video-block-bg-pink.svg" alt="">
		<img class="video-block__bg-white" src="/madbackpacks-dev/images/video-block-bg-white.svg" alt="">

		<div class="video-block__wrapper">

			<a href="#" class="video-block__play" @click.prevent="videoPopupShow()">
				<img src="/madbackpacks-dev/images/video-play.svg" alt="">
			</a>
			<!-- <vue-player video-placeholder-src="/madbackpacks-dev/images/video.mp4" src="/madbackpacks-dev/images/video.mp4" poster="/madbackpacks-dev/images/video-thumb.jpg"
	...
	data() {
		return {
			...
			playerOptions: {
				...
				sources: [{
					type: "video/mp4",
					src: "/madbackpacks-dev/images/video-thumb.mp4"
				}],
				poster: "/madbackpacks-dev/images/video-thumb.jpg",
				controls: false,
			},
			playerPopupOptions: {
				// videojs options
				...
				sources: [{
					type: "video/mp4",
					src: "/madbackpacks-dev/images/video.mp4"
				}],
				poster: "/madbackpacks-dev/images/video-thumb.jpg",
				controls: false,
			},
